...
SET(Matlab_ROOT_DIR "Matlab_ROOT_DIR-NOTFOUND")
...
IF(Matlab_EXECUTABLE)
	...
	IF(Matlab_ROOT_DIR)
		# OV_PRINT(OV_PRINTED "Have Matlab_ROOT_DIR ${Matlab_ROOT_DIR}")
		SET(Matlab_ROOT_DIR ${Matlab_ROOT_DIR}/../)
		# OV_PRINT(OV_PRINTED " -> ${Matlab_ROOT_DIR}")	
		FIND_PATH(Matlab_INCLUDE "mex.h" PATHS ${Matlab_ROOT_DIR}/extern/include ${Matlab_ROOT_DIR}/extern/include/extern)
	ENDIF()
	...
	IF((NOT Matlab_INCLUDE) AND UNIX)
		EXECUTE_PROCESS(COMMAND matlab -e COMMAND grep "^MATLAB=" COMMAND sed "s/^MATLAB=//g" COMMAND tr "\n" "/" 
				OUTPUT_VARIABLE Matlab_ROOT_DIR)
		FIND_PATH(Matlab_INCLUDE "mex.h" PATHS ${Matlab_ROOT_DIR}/extern/include ${Matlab_ROOT_DIR}/extern/include/extern)
	ENDIF()
	...
	IF(Matlab_INCLUDE)
		...
		IF(UNIX)
			...
			IF(CMAKE_SIZEOF_VOID_P EQUAL 4)
				SET(Matlab_LIB_DIRECTORIES ${Matlab_ROOT_DIR}/bin/glnx86)
			ELSE()
				SET(Matlab_LIB_DIRECTORIES ${Matlab_ROOT_DIR}/bin/glnxa64)
			ENDIF()
		ENDIF(UNIX)
		IF(WIN32)
			SET(Matlab_LIBRARIES libmex libmx libeng) #mclmcrrt
			IF(CMAKE_SIZEOF_VOID_P EQUAL 4)
				SET(Matlab_LIB_DIRECTORIES ${Matlab_ROOT_DIR}/extern/lib/win32/microsoft)
			ELSE()
				SET(Matlab_LIB_DIRECTORIES ${Matlab_ROOT_DIR}/extern/lib/win64/microsoft)
			ENDIF()
...
IF(Matlab_FOUND)
	#OV_PRINT(OV_PRINTED "  Found Matlab in [${Matlab_ROOT_DIR}]")
